...
public class Etudiant extends Personne {
    ...
    public double calculerMoyenneGenerale() {
        ...
        for (Inscription ins : inscriptions) {
            try {
                ...
                //ignore les matieres sans notes pour calcul general
            }
        }
    ...
    /**
     * genere le releve de notes complet pour l'etudiant
     * 
    ...
    public String genererReleve() {
        ...
        sb.append("\n");
        sb.append("ETUDIANT : ").append(this.getNom()).append(" ").append(this.getPrenom()).append(" ");
        sb.append("\n");
        ...
        for (Inscription ins : inscriptions) {
            sb.append("GROUPE : ").append(ins.getGroupe()).append(" ");
            sb.append("\n");
            sb.append("MATIERE : ").append(ins.getGroupe().toString());
            sb.append("\n");
            sb.append("NOTES : ");

            sb.append("Detail des notes : ");
            ...
            try {
                ...
                sb.append("> Moyenne Matiere : Pas de notes enregistres");
            }
     ...
     * <p>affiche le role, l'identite complete, le matricule rt la filiere</p>
     */
    @Override
